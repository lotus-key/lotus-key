...
## Purpose
Defines the internationalization (i18n) requirements for LotusKey, enabling localized user interfaces in English and Vietnamese.
...
- `ui-settings` - UI components that require localization
